package es.uam.irg.nlp.corenlp;
...
public class CoreNLPDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String nlpPath = System.getenv("CORENLP_HOME");
        String text;
        ...
        switch (language) {
            case LANG_EN:
                ...
                text = "Kosgi Santosh is the person who sent an email to Stanford University. He didn't get a reply.";
                break;
            case LANG_ES:
                props.load(new FileInputStream(nlpPath + "/StanfordCoreNLP-spanish.properties"));
                text = "Kosgi Santosh es la persona que envió un email a la Universidad de Stanford. Él no recibió respuesta.";
                break;
            default:
                throw new Exception("Not supported language:" + language);
        }
