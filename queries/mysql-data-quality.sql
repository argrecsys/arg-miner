...
UPDATE proposal_comments
 ...
 -- Soy usuario habitual de bici ( un suicida, vamos ;) pero considero que no se deberia gastar mucho.en esta propuesta. Ya hay tanto trasto y cachivache, vallas, bolardos etc que anadir mas afearia la ciudad. Basta con ver fotos antiguas de la ciudad y la belleza de calles y avenidas amplias y con pocos obstaculos. Y con una diferencoa fundamental...la densidad de vehiculos es mucho menor. El uso del automovil se ha democratizado y ha invadido literalmebte la ciudad. Es un circulo vicioso que no se resuelve realmente separando un carril para bicis sino.disminuyendo la cantidad de vehiculos rodados. Entiendo q prohibir es menos popular y menos en nuestro pais en que como se suele decir se lleva el coche hasta para mear. Con nuestro clima muchisima gente la usaria si no fuera peligroso. Y cambiar con educacion la cultura de cochazo=guay. No se la solucion pero hay mucha calle para repartir. Estudiad formulas de otros paises etc pero a mi la banda pintada de rojo no me gusta. -coches+bic
 UPDATE proposal_comments
   SET text = 'Soy usuario habitual de bici (un suicida, vamos) pero considero que no se deberia gastar mucho en esta propuesta. Ya hay tanto trasto y cachivache, vallas, bolardos, etc que anadir mas afearia la ciudad. Basta con ver fotos antiguas de la ciudad y la belleza de calles y avenidas amplias y con pocos obstaculos. Y con una diferencoa fundamental... la densidad de vehiculos es mucho menor. El uso del automovil se ha democratizado y ha invadido literalmebte la ciudad. Es un circulo vicioso que no se resuelve realmente separando un carril para bicis sino disminuyendo la cantidad de vehiculos rodados. Entiendo que prohibir es menos popular y menos en nuestro pais en que como se suele decir se lleva el coche hasta para mear. Con nuestro clima muchisima gente la usaria si no fuera peligroso. Y cambiar con educacion la cultura de cochazo=guay. No se la solucion pero hay mucha calle para repartir. Estudiad formulas de otros paises etc pero a mi la banda pintada de rojo no me gusta. -coches+bic'
 WHERE id = 78077;
